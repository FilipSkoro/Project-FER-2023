...
def publish_Distances(median_dis):
    ...
    pub = rospy.Publisher('rpi0_topic', DistanceMsg, queue_size=10)
...
if __name__ == "__main__":
    ...
    mac_addresses = ["DC:A6:32:EA:37:A7","DC:A6:32:D4:3F:56","DC:A6:32:D4:3F:A6"]

    rospy.init_node('Rpi0', anonymous=True)
